#ifndef JMLANG_LANG_RDOM_H
#define JMLANG_LANG_RDOM_H
...
class RVar {
 ...
 public:
  ...
  RVar(std::string __name, Expr __min, Expr __extent,
...
class RDom {
 ...
 public:
   ...
   * name. If the name is left blank, a unique one is
   * auto-generated. */
  RDom(Expr min0, Expr extent0, Expr min1, Expr extent1, Expr min2,
       Expr extent2, std::string name = "");

  /** Construct a four-dimensional reduction domain with the given
   * name. If the name is left blank, a unique one is
   * auto-generated. */
  RDom(Expr min0, Expr extent0, Expr min1, Expr extent1, Expr min2,
       Expr extent2, Expr min3, Expr extent3, std::string name = "");
  ...
  /** Construct a reduction domain that wraps an internal ReductionDomain
   * object. */
  ...
  /** Single-dimensional reduction domains can be also be used as Exprs
   * directly. */
  operator Expr() const;
